...
public:
  ...
  void updateAudioData(const double *timeData, const double *fftData, int size,
                       double sampleRate);
...
private:
  ...
  static constexpr qint64 LABEL_UPDATE_INTERVAL_MS =
      250; // Update labels every 250ms

  void setupPlot(QCustomPlot *plot, const QString &xLabel,
