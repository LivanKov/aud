...
public:
  ...
  }; // if your application already uses the id (QTextFormat::UserObject +
     // 3902), just change the id here
  ...
  static QTextCharFormat generatePlotFormat(QCustomPlot *plot, int width = 0,
                                            int height = 0);
};
