...
typedef struct IAudioEndpointVolumeCallbackVtbl {
  ...
  (IAudioEndpointVolumeCallback *This, PAUDIO_VOLUME_NOTIFICATION_DATA pNotify);
...
public:
  ...
  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE SetChannelVolumeLevel(
      /* [in] */
      __in UINT nChannel, float fLevelDB,
      /* [unique][in] */ LPCGUID pguidEventContext) = 0;

  virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE
  SetChannelVolumeLevelScalar(
      /* [in] */
      __in UINT nChannel, float fLevel,
      /* [unique][in] */ LPCGUID pguidEventContext) = 0;
...
#define IAudioEndpointVolume_SetMasterVolumeLevel(This, fLevelDB,              \
                                                  pguidEventContext)           \
  ((This)->lpVtbl->SetMasterVolumeLevel(This, fLevelDB, pguidEventContext))

#define IAudioEndpointVolume_SetMasterVolumeLevelScalar(This, fLevel,          \
                                                        pguidEventContext)     \
...
#define IAudioEndpointVolume_SetChannelVolumeLevel(This, nChannel, fLevelDB,   \
                                                   pguidEventContext)          \
  ((This)->lpVtbl->SetChannelVolumeLevel(This, nChannel, fLevelDB,             \
                                         pguidEventContext))

#define IAudioEndpointVolume_SetChannelVolumeLevelScalar(                      \
    This, nChannel, fLevel, pguidEventContext)                                 \
  ((This)->lpVtbl->SetChannelVolumeLevelScalar(This, nChannel, fLevel,         \
                                               pguidEventContext))
...
#define IAudioEndpointVolume_GetChannelVolumeLevelScalar(This, nChannel,       \
                                                         pfLevel)              \
...
#define IAudioEndpointVolume_QueryHardwareSupport(This,                        \
                                                  pdwHardwareSupportMask)      \
  ((This)->lpVtbl->QueryHardwareSupport(This, pdwHardwareSupportMask))

#define IAudioEndpointVolume_GetVolumeRange(                                   \
    This, pflVolumeMindB, pflVolumeMaxdB, pflVolumeIncrementdB)                \
  ((This)->lpVtbl->GetVolumeRange(This, pflVolumeMindB, pflVolumeMaxdB,        \
...
#define IAudioMeterInformation_GetChannelsPeakValues(This, u32ChannelCount,    \
                                                     afPeakValues)             \
  ((This)->lpVtbl->GetChannelsPeakValues(This, u32ChannelCount, afPeakValues))

#define IAudioMeterInformation_QueryHardwareSupport(This,                      \
                                                    pdwHardwareSupportMask)    \
  ((This)->lpVtbl->QueryHardwareSupport(This, pdwHardwareSupportMask))
