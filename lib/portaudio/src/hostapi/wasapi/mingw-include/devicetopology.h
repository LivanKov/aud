...
//
//   Flag for clients of IControlChangeNotify::OnNotify to allow those clients
//   to identify hardware initiated notifications
//
#define DEVTOPO_HARDWARE_INITIATED_EVENTCONTEXT 'draH'
/* E2C2E9DE-09B1-4B04-84E5-07931225EE04 */
DEFINE_GUID(EVENTCONTEXT_VOLUMESLIDER, 0xE2C2E9DE, 0x09B1, 0x4B04, 0x84, 0xE5,
            0x07, 0x93, 0x12, 0x25, 0xEE, 0x04);
#define _IKsControl_
#include "ks.h"
#include "ksmedia.h"
#ifndef _KS_
...
#define IKsControl_KsProperty(This, Property, PropertyLength, PropertyData,    \
                              DataLength, BytesReturned)                       \
  ((This)->lpVtbl->KsProperty(This, Property, PropertyLength, PropertyData,    \
                              DataLength, BytesReturned))

#define IKsControl_KsMethod(This, Method, MethodLength, MethodData,            \
                            DataLength, BytesReturned)                         \
  ((This)->lpVtbl->KsMethod(This, Method, MethodLength, MethodData,            \
                            DataLength, BytesReturned))

#define IKsControl_KsEvent(This, Event, EventLength, EventData, DataLength,    \
                           BytesReturned)                                      \
  ((This)->lpVtbl->KsEvent(This, Event, EventLength, EventData, DataLength,    \
                           BytesReturned))
...
#define IPerChannelDbLevel_GetLevelRange(This, nChannel, pfMinLevelDB,         \
                                         pfMaxLevelDB, pfStepping)             \
  ((This)->lpVtbl->GetLevelRange(This, nChannel, pfMinLevelDB, pfMaxLevelDB,   \
                                 pfStepping))

#define IPerChannelDbLevel_GetLevel(This, nChannel, pfLevelDB)                 \
  ((This)->lpVtbl->GetLevel(This, nChannel, pfLevelDB))

#define IPerChannelDbLevel_SetLevel(This, nChannel, fLevelDB,                  \
                                    pguidEventContext)                         \
...
#define IPerChannelDbLevel_SetLevelAllChannels(This, aLevelsDB, cChannels,     \
                                               pguidEventContext)              \
  ((This)->lpVtbl->SetLevelAllChannels(This, aLevelsDB, cChannels,             \
                                       pguidEventContext))
...
IAudioVolumeLevel : public IPerChannelDbLevel{public : };
...
#define IAudioVolumeLevel_GetLevelRange(This, nChannel, pfMinLevelDB,          \
                                        pfMaxLevelDB, pfStepping)              \
  ((This)->lpVtbl->GetLevelRange(This, nChannel, pfMinLevelDB, pfMaxLevelDB,   \
                                 pfStepping))
...
#define IAudioVolumeLevel_SetLevel(This, nChannel, fLevelDB,                   \
                                   pguidEventContext)                          \
  ((This)->lpVtbl->SetLevel(This, nChannel, fLevelDB, pguidEventContext))
...
#define IAudioVolumeLevel_SetLevelAllChannels(This, aLevelsDB, cChannels,      \
                                              pguidEventContext)               \
  ((This)->lpVtbl->SetLevelAllChannels(This, aLevelsDB, cChannels,             \
                                       pguidEventContext))
...
#define IAudioChannelConfig_SetChannelConfig(This, dwConfig,                   \
                                             pguidEventContext)                \
...
IAudioBass : public IPerChannelDbLevel{public : };
...
#define IAudioBass_GetLevelRange(This, nChannel, pfMinLevelDB, pfMaxLevelDB,   \
                                 pfStepping)                                   \
  ((This)->lpVtbl->GetLevelRange(This, nChannel, pfMinLevelDB, pfMaxLevelDB,   \
                                 pfStepping))
...
#define IAudioBass_SetLevelAllChannels(This, aLevelsDB, cChannels,             \
                                       pguidEventContext)                      \
  ((This)->lpVtbl->SetLevelAllChannels(This, aLevelsDB, cChannels,             \
                                       pguidEventContext))
...
IAudioMidrange : public IPerChannelDbLevel{public : };
...
#define IAudioMidrange_GetLevelRange(This, nChannel, pfMinLevelDB,             \
                                     pfMaxLevelDB, pfStepping)                 \
  ((This)->lpVtbl->GetLevelRange(This, nChannel, pfMinLevelDB, pfMaxLevelDB,   \
                                 pfStepping))
...
#define IAudioMidrange_SetLevelAllChannels(This, aLevelsDB, cChannels,         \
                                           pguidEventContext)                  \
  ((This)->lpVtbl->SetLevelAllChannels(This, aLevelsDB, cChannels,             \
                                       pguidEventContext))
...
IAudioTreble : public IPerChannelDbLevel{public : };
...
#define IAudioTreble_GetLevelRange(This, nChannel, pfMinLevelDB, pfMaxLevelDB, \
                                   pfStepping)                                 \
  ((This)->lpVtbl->GetLevelRange(This, nChannel, pfMinLevelDB, pfMaxLevelDB,   \
                                 pfStepping))
...
#define IAudioTreble_SetLevelAllChannels(This, aLevelsDB, cChannels,           \
                                         pguidEventContext)                    \
  ((This)->lpVtbl->SetLevelAllChannels(This, aLevelsDB, cChannels,             \
                                       pguidEventContext))
...
#define IDeviceSpecificProperty_SetValue(This, pvValue, cbValue,               \
                                         pguidEventContext)                    \
...
#define IKsFormatSupport_IsFormatSupported(This, pKsFormat, cbFormat,          \
                                           pbSupported)                        \
...
typedef struct IPartVtbl {
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *RegisterControlChangeCallback)(
      IPart *This,
      /* [in] */
      __in REFGUID riid,
      /* [in] */
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *UnregisterControlChangeCallback)(
      IPart *This,
      /* [in] */
      __in IControlChangeNotify *pNotify);
...
ISubunit : public IUnknown{public : };
...
#define IControlChangeNotify_OnNotify(This, dwSenderProcessId,                 \
                                      pguidEventContext)                       \
...
#define IDeviceTopology_GetSignalPath(This, pIPartFrom, pIPartTo,              \
                                      bRejectMixedPaths, ppParts)              \
  ((This)->lpVtbl->GetSignalPath(This, pIPartFrom, pIPartTo,                   \
                                 bRejectMixedPaths, ppParts))
