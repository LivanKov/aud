...
typedef /* [v1_enum] */
    enum tagQUERY_PARSER_MANAGER_OPTION {
      ...
      QPMO_LOCALIZED_SCHEMA_BINARY_PATH =
          (QPMO_UNLOCALIZED_SCHEMA_BINARY_PATH + 1),
      QPMO_APPEND_LCID_TO_LOCALIZED_PATH =
          (QPMO_LOCALIZED_SCHEMA_BINARY_PATH + 1),
...
public:
  virtual HRESULT STDMETHODCALLTYPE Parse(
      ...
      /* [retval][out] */ __RPC__deref_out_opt IQuerySolution *
          *ppSolution) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetSchemaProvider(
      /* [retval][out] */ __RPC__deref_out_opt ISchemaProvider *
      *ppSchemaProvider) = 0;
...
#define IQueryParser_Parse(This, pszInputString, pCustomProperties,            \
                           ppSolution)                                         \
...
#define IQueryParser_RestateToString(This, pCondition, fUseEnglish,            \
                                     ppszQueryString)                          \
  ((This)->lpVtbl->RestateToString(This, pCondition, fUseEnglish,              \
                                   ppszQueryString))

#define IQueryParser_ParsePropertyValue(This, pszPropertyName, pszInputString, \
                                        ppSolution)                            \
  ((This)->lpVtbl->ParsePropertyValue(This, pszPropertyName, pszInputString,   \
                                      ppSolution))

#define IQueryParser_RestatePropertyValueToString(                             \
    This, pCondition, fUseEnglish, ppszPropertyName, ppszQueryString)          \
  ((This)->lpVtbl->RestatePropertyValueToString(                               \
      This, pCondition, fUseEnglish, ppszPropertyName, ppszQueryString))
...
#define IConditionFactory_MakeNot(This, pSubCondition, simplify,               \
                                  ppResultQuery)                               \
  ((This)->lpVtbl->MakeNot(This, pSubCondition, simplify, ppResultQuery))

#define IConditionFactory_MakeAndOr(This, nodeType, pSubConditions, simplify,  \
                                    ppResultQuery)                             \
  ((This)->lpVtbl->MakeAndOr(This, nodeType, pSubConditions, simplify,         \
                             ppResultQuery))

#define IConditionFactory_MakeLeaf(This, pszPropertyName, op, pszValueType,    \
                                   pValue, pPropertyNameTerm, pOperationTerm,  \
                                   pValueTerm, expand, ppResultQuery)          \
  ((This)->lpVtbl->MakeLeaf(This, pszPropertyName, op, pszValueType, pValue,   \
                            pPropertyNameTerm, pOperationTerm, pValueTerm,     \
                            expand, ppResultQuery))

#define IConditionFactory_Resolve(This, pConditionTree, sqro,                  \
                                  pstReferenceTime, ppResolvedConditionTree)   \
  ((This)->lpVtbl->Resolve(This, pConditionTree, sqro, pstReferenceTime,       \
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetErrors(
      /* [in] */ __RPC__in REFIID riid,
      /* [iid_is][retval][out] */ __RPC__deref_out_opt void *
          *ppParseErrors) = 0;
...
#define IQuerySolution_MakeAndOr(This, nodeType, pSubConditions, simplify,     \
                                 ppResultQuery)                                \
  ((This)->lpVtbl->MakeAndOr(This, nodeType, pSubConditions, simplify,         \
                             ppResultQuery))

#define IQuerySolution_MakeLeaf(This, pszPropertyName, op, pszValueType,       \
                                pValue, pPropertyNameTerm, pOperationTerm,     \
                                pValueTerm, expand, ppResultQuery)             \
  ((This)->lpVtbl->MakeLeaf(This, pszPropertyName, op, pszValueType, pValue,   \
                            pPropertyNameTerm, pOperationTerm, pValueTerm,     \
...
#define IQuerySolution_Resolve(This, pConditionTree, sqro, pstReferenceTime,   \
                               ppResolvedConditionTree)                        \
  ((This)->lpVtbl->Resolve(This, pConditionTree, sqro, pstReferenceTime,       \
                           ppResolvedConditionTree))
...
#define IQuerySolution_GetLexicalData(This, ppszInputString, ppTokens,         \
                                      pLocale, ppWordBreaker)                  \
  ((This)->lpVtbl->GetLexicalData(This, ppszInputString, ppTokens, pLocale,    \
                                  ppWordBreaker))
...
#define ICondition_GetComparisonInfo(This, ppszPropertyName, pOperation,       \
                                     pValue)                                   \
  ((This)->lpVtbl->GetComparisonInfo(This, ppszPropertyName, pOperation,       \
                                     pValue))
...
#define ICondition_GetInputTerms(This, ppPropertyTerm, ppOperationTerm,        \
                                 ppValueTerm)                                  \
  ((This)->lpVtbl->GetInputTerms(This, ppPropertyTerm, ppOperationTerm,        \
                                 ppValueTerm))
...
#define IConditionGenerator_RecognizeNamedEntities(                            \
    This, pszInputString, lcid, pTokenCollection, pNamedEntities)              \
  ((This)->lpVtbl->RecognizeNamedEntities(This, pszInputString, lcid,          \
                                          pTokenCollection, pNamedEntities))

#define IConditionGenerator_GenerateForLeaf(                                   \
    This, pConditionFactory, pszPropertyName, op, pszValueType, pszValue,      \
    pszValue2, pPropertyNameTerm, pOperationTerm, pValueTerm,                  \
    automaticWildcard, pNoStringQuery, ppQueryExpression)                      \
  ((This)->lpVtbl->GenerateForLeaf(                                            \
      This, pConditionFactory, pszPropertyName, op, pszValueType, pszValue,    \
      pszValue2, pPropertyNameTerm, pOperationTerm, pValueTerm,                \
      automaticWildcard, pNoStringQuery, ppQueryExpression))

#define IConditionGenerator_DefaultPhrase(This, pszValueType, ppropvar,        \
                                          fUseEnglish, ppszPhrase)             \
  ((This)->lpVtbl->DefaultPhrase(This, pszValueType, ppropvar, fUseEnglish,    \
                                 ppszPhrase))
...
#define IInterval_GetLimits(This, pilkLower, ppropvarLower, pilkUpper,         \
                            ppropvarUpper)                                     \
  ((This)->lpVtbl->GetLimits(This, pilkLower, ppropvarLower, pilkUpper,        \
                             ppropvarUpper))
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetRelationship(
      ...
      /* [retval][out] */ __RPC__deref_out_opt IRelationship *
          *pRelationship) = 0;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetNamedEntity(
      /* [in] */ __RPC__in LPCWSTR pszValue,
      /* [retval][out] */ __RPC__deref_out_opt INamedEntity *
          *ppNamedEntity) = 0;
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Destination(
      /* [retval][out] */ __RPC__deref_out_opt IEntity *
      *pDestinationEntity) = 0;
...
#define ISchemaProvider_LookupAuthoredNamedEntity(                             \
    This, pEntity, pszInputString, pTokenCollection, cTokensBegin,             \
    pcTokensLength, ppszValue)                                                 \
  ((This)->lpVtbl->LookupAuthoredNamedEntity(This, pEntity, pszInputString,    \
                                             pTokenCollection, cTokensBegin,   \
                                             pcTokensLength, ppszValue))
...
public:
  virtual HRESULT STDMETHODCALLTYPE NumberOfTokens(__RPC__in ULONG *
                                                   pCount) = 0;
...
typedef struct ITokenCollectionVtbl {
  ...
  (ITokenCollection *This, __RPC__in ULONG *pCount);
...
#define INamedEntityCollector_Add(This, beginSpan, endSpan, beginActual,       \
                                  endActual, pType, pszValue, certainty)       \
  ((This)->lpVtbl->Add(This, beginSpan, endSpan, beginActual, endActual,       \
                       pType, pszValue, certainty))
...
#define ISchemaLocalizerSupport_Localize(This, pszGlobalString,                \
                                         ppszLocalString)                      \
...
#define IQueryParserManager_CreateLoadedParser(                                \
    This, pszCatalog, langidForKeywords, riid, ppQueryParser)                  \
  ((This)->lpVtbl->CreateLoadedParser(This, pszCatalog, langidForKeywords,     \
                                      riid, ppQueryParser))

#define IQueryParserManager_InitializeOptions(This, fUnderstandNQS,            \
                                              fAutoWildCard, pQueryParser)     \
  ((This)->lpVtbl->InitializeOptions(This, fUnderstandNQS, fAutoWildCard,      \
                                     pQueryParser))
...
unsigned long __RPC_USER LPSAFEARRAY_UserSize(unsigned long *, unsigned long,
                                              LPSAFEARRAY *);
