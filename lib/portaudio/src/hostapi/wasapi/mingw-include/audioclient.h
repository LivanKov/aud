...
#define IAudioClient_Initialize(This, ShareMode, StreamFlags,                  \
                                hnsBufferDuration, hnsPeriodicity, pFormat,    \
                                AudioSessionGuid)                              \
  ((This)->lpVtbl->Initialize(This, ShareMode, StreamFlags, hnsBufferDuration, \
...
#define IAudioClient_IsFormatSupported(This, ShareMode, pFormat,               \
                                       ppClosestMatch)                         \
...
#define IAudioClient_GetDevicePeriod(This, phnsDefaultDevicePeriod,            \
                                     phnsMinimumDevicePeriod)                  \
  ((This)->lpVtbl->GetDevicePeriod(This, phnsDefaultDevicePeriod,              \
                                   phnsMinimumDevicePeriod))
...
#define IAudioCaptureClient_GetBuffer(This, ppData, pNumFramesToRead,          \
                                      pdwFlags, pu64DevicePosition,            \
                                      pu64QPCPosition)                         \
  ((This)->lpVtbl->GetBuffer(This, ppData, pNumFramesToRead, pdwFlags,         \
...
#define IChannelAudioVolume_SetChannelVolume(This, dwIndex, fLevel,            \
                                             EventContext)                     \
...
#define IChannelAudioVolume_SetAllVolumes(This, dwCount, pfVolumes,            \
                                          EventContext)                        \
