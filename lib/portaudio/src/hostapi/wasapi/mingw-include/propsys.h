...
typedef enum tagPROPDESC_RELATIVEDESCRIPTION_TYPE
...
#define IPropertyDescription_GetRelativeDescription(This, propvar1, propvar2,  \
                                                    ppszDesc1, ppszDesc2)      \
...
#define IPropertyDescription_GetSortDescriptionLabel(This, fDescending,        \
                                                     ppszDescription)          \
...
#define IPropertyDescription_FormatForDisplay(This, propvar, pdfFlags,         \
                                              ppszDisplay)                     \
...
#define IPropertyDescriptionAliasInfo_GetRelativeDescription(                  \
...
#define IPropertyDescriptionAliasInfo_GetSortDescriptionLabel(                 \
...
#define IPropertyDescriptionAliasInfo_GetConditionType(This, pcontype,         \
                                                       popDefault)             \
  ((This)->lpVtbl->GetConditionType(This, pcontype, popDefault))
...
#define IPropertyDescriptionAliasInfo_FormatForDisplay(This, propvar,          \
                                                       pdfFlags, ppszDisplay)  \
  ((This)->lpVtbl->FormatForDisplay(This, propvar, pdfFlags, ppszDisplay))
...
#define IPropertyDescriptionAliasInfo_GetAdditionalSortByAliases(This, riid,   \
                                                                 ppv)          \
...
#define IPropertyDescriptionSearchInfo_GetRelativeDescription(                 \
    This, propvar1, propvar2, ppszDesc1, ppszDesc2)                            \
  ((This)->lpVtbl->GetRelativeDescription(This, propvar1, propvar2, ppszDesc1, \
                                          ppszDesc2))
...
#define IPropertyDescriptionSearchInfo_GetSortDescriptionLabel(                \
    This, fDescending, ppszDescription)                                        \
  ((This)->lpVtbl->GetSortDescriptionLabel(This, fDescending, ppszDescription))
...
#define IPropertyDescriptionSearchInfo_GetConditionType(This, pcontype,        \
                                                        popDefault)            \
  ((This)->lpVtbl->GetConditionType(This, pcontype, popDefault))
...
#define IPropertyDescriptionSearchInfo_FormatForDisplay(This, propvar,         \
                                                        pdfFlags, ppszDisplay) \
  ((This)->lpVtbl->FormatForDisplay(This, propvar, pdfFlags, ppszDisplay))
...
#define IPropertyDescriptionSearchInfo_GetProjectionString(This,               \
                                                           ppszProjection)     \
...
#define IPropertySystem_GetPropertyDescriptionByName(This, pszCanonicalName,   \
                                                     riid, ppv)                \
  ((This)->lpVtbl->GetPropertyDescriptionByName(This, pszCanonicalName, riid,  \
                                                ppv))

#define IPropertySystem_GetPropertyDescriptionListFromString(                  \
    This, pszPropList, riid, ppv)                                              \
  ((This)->lpVtbl->GetPropertyDescriptionListFromString(This, pszPropList,     \
                                                        riid, ppv))

#define IPropertySystem_EnumeratePropertyDescriptions(This, filterOn, riid,    \
                                                      ppv)                     \
  ((This)->lpVtbl->EnumeratePropertyDescriptions(This, filterOn, riid, ppv))

#define IPropertySystem_FormatForDisplay(This, key, propvar, pdff, pszText,    \
                                         cchText)                              \
  ((This)->lpVtbl->FormatForDisplay(This, key, propvar, pdff, pszText, cchText))

#define IPropertySystem_FormatForDisplayAlloc(This, key, propvar, pdff,        \
                                              ppszDisplay)                     \
...
#define IPropertyStoreFactory_GetPropertyStore(This, flags, pUnkFactory, riid, \
                                               ppv)                            \
  ((This)->lpVtbl->GetPropertyStore(This, flags, pUnkFactory, riid, ppv))

#define IPropertyStoreFactory_GetPropertyStoreForKeys(This, rgKeys, cKeys,     \
                                                      flags, riid, ppv)        \
  ((This)->lpVtbl->GetPropertyStoreForKeys(This, rgKeys, cKeys, flags, riid,   \
                                           ppv))
...
#define IDelayedPropertyStoreFactory_GetPropertyStore(This, flags,             \
                                                      pUnkFactory, riid, ppv)  \
  ((This)->lpVtbl->GetPropertyStore(This, flags, pUnkFactory, riid, ppv))

#define IDelayedPropertyStoreFactory_GetPropertyStoreForKeys(                  \
    This, rgKeys, cKeys, flags, riid, ppv)                                     \
  ((This)->lpVtbl->GetPropertyStoreForKeys(This, rgKeys, cKeys, flags, riid,   \
                                           ppv))

#define IDelayedPropertyStoreFactory_GetDelayedPropertyStore(                  \
...
#define GUIDSTRING_MAX                                                         \
  (1 + 8 + 1 + 4 + 1 + 4 + 1 + 4 + 1 + 12 + 1 +                                \
   1) // "{12345678-1234-1234-1234-123456789012}"
...
PSSTDAPI PSStringFromPropertyKey(__in REFPROPERTYKEY pkey,
                                 __out_ecount(cch) LPWSTR psz, __in UINT cch);
...
PSSTDAPI PSCreateDelayedMultiplexPropertyStore(
    __in GETPROPERTYSTOREFLAGS flags, __in IDelayedPropertyStoreFactory *pdpsf,
    __in_ecount(cStores) const DWORD *rgStoreIds, __in DWORD cStores,
    __in REFIID riid, __deref_out void **ppv);

// Create a read-only property store from one or more sources (which each must
// support either IPropertyStore or IPropertySetStorage) Returns an
// IPropertyStore interface or related interfaces
PSSTDAPI PSCreateMultiplexPropertyStore(__in_ecount(cStores)
                                            IUnknown **prgpunkStores,
                                        __in DWORD cStores, __in REFIID riid,
...
PSSTDAPI PSCreatePropertyChangeArray(
    ...
    __in_ecount_opt(cChanges) const PROPVARIANT *rgpropvar, __in UINT cChanges,
    __in REFIID riid, __deref_out void **ppv);
...
PSSTDAPI PSGetPropertyDescription(__in REFPROPERTYKEY propkey, __in REFIID riid,
                                  __deref_out void **ppv);
...
PSSTDAPI PSGetItemPropertyHandler(__in IUnknown *punkItem, __in BOOL fReadWrite,
                                  __in REFIID riid, __deref_out void **ppv);
...
PSSTDAPI PSGetItemPropertyHandlerWithCreateObject(
    __in IUnknown *punkItem, __in BOOL fReadWrite,
    __in IUnknown *punkCreateObject, __in REFIID riid, __deref_out void **ppv);
...
PSSTDAPI
PSCreatePropertyStoreFromPropertySetStorage(__in IPropertySetStorage *ppss,
                                            DWORD grfMode, REFIID riid,
                                            __deref_out void **ppv);
...
PSSTDAPI PSCreatePropertyStoreFromObject(__in IUnknown *punk,
                                         __in DWORD grfMode, __in REFIID riid,
                                         __deref_out void **ppv);
...
PSSTDAPI PSGetPropertyFromPropertyStorage(__in_bcount(cb)
...
PSSTDAPI PSGetNamedPropertyFromPropertyStorage(
    __in_bcount(cb) PCUSERIALIZEDPROPSTORAGE psps, __in DWORD cb,
    __in LPCWSTR pszName, __out PROPVARIANT *ppropvar);
...
unsigned long __RPC_USER BSTR_UserSize64(unsigned long *, unsigned long,
                                         BSTR *);
...
unsigned long __RPC_USER LPSAFEARRAY_UserSize64(unsigned long *, unsigned long,
                                                LPSAFEARRAY *);
...
IInitializeWithStream_Initialize_Proxy(IInitializeWithStream *This,
                                       /* [in] */ IStream *pstream,
                                       /* [in] */ DWORD grfMode);

/* [call_as] */ HRESULT STDMETHODCALLTYPE
IInitializeWithStream_Initialize_Stub(IInitializeWithStream *This,
                                      /* [in] */ __RPC__in_opt IStream *pstream,
                                      /* [in] */ DWORD grfMode);
