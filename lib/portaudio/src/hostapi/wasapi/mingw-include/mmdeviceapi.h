...
DEFINE_PROPERTYKEY(PKEY_AudioEndpoint_ControlPanelPageProvider, 0x1da5d803,
                   0xd492, 0x4edd, 0x8c, 0x23, 0xe0, 0xc0, 0xff, 0xee, 0x7f,
                   0x0e, 1);
DEFINE_PROPERTYKEY(PKEY_AudioEndpoint_Association, 0x1da5d803, 0xd492, 0x4edd,
                   0x8c, 0x23, 0xe0, 0xc0, 0xff, 0xee, 0x7f, 0x0e, 2);
DEFINE_PROPERTYKEY(PKEY_AudioEndpoint_PhysicalSpeakers, 0x1da5d803, 0xd492,
                   0x4edd, 0x8c, 0x23, 0xe0, 0xc0, 0xff, 0xee, 0x7f, 0x0e, 3);
DEFINE_PROPERTYKEY(PKEY_AudioEndpoint_GUID, 0x1da5d803, 0xd492, 0x4edd, 0x8c,
                   0x23, 0xe0, 0xc0, 0xff, 0xee, 0x7f, 0x0e, 4);
DEFINE_PROPERTYKEY(PKEY_AudioEndpoint_Disable_SysFx, 0x1da5d803, 0xd492, 0x4edd,
                   0x8c, 0x23, 0xe0, 0xc0, 0xff, 0xee, 0x7f, 0x0e, 5);
...
DEFINE_PROPERTYKEY(PKEY_AudioEndpoint_FullRangeSpeakers, 0x1da5d803, 0xd492,
                   0x4edd, 0x8c, 0x23, 0xe0, 0xc0, 0xff, 0xee, 0x7f, 0x0e, 6);
...
#define IMMNotificationClient_OnDeviceStateChanged(This, pwstrDeviceId,        \
                                                   dwNewState)                 \
...
#define IMMNotificationClient_OnDefaultDeviceChanged(This, flow, role,         \
                                                     pwstrDefaultDeviceId)     \
  ((This)->lpVtbl->OnDefaultDeviceChanged(This, flow, role,                    \
                                          pwstrDefaultDeviceId))
...
#define IMMDevice_Activate(This, iid, dwClsCtx, pActivationParams,             \
                           ppInterface)                                        \
  ((This)->lpVtbl->Activate(This, iid, dwClsCtx, pActivationParams,            \
                            ppInterface))
...
typedef struct IMMDeviceEnumeratorVtbl {
  ...
  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *RegisterEndpointNotificationCallback)(
      IMMDeviceEnumerator *This,
      /* [in] */
      __in IMMNotificationClient *pClient);

  /* [helpstring][id] */ HRESULT(
      STDMETHODCALLTYPE *UnregisterEndpointNotificationCallback)(
      IMMDeviceEnumerator *This,
      /* [in] */
      __in IMMNotificationClient *pClient);
...
#define IMMDeviceEnumerator_EnumAudioEndpoints(This, dataFlow, dwStateMask,    \
                                               ppDevices)                      \
  ((This)->lpVtbl->EnumAudioEndpoints(This, dataFlow, dwStateMask, ppDevices))

#define IMMDeviceEnumerator_GetDefaultAudioEndpoint(This, dataFlow, role,      \
                                                    ppEndpoint)                \
...
#define IMMDeviceActivator_Activate(This, iid, pDevice, pActivationParams,     \
                                    ppInterface)                               \
